...
if not st.session_state.logueado:
    ...
    st.image("/Users/pelayoquiros/Desktop/Proyect/Master Python Avanzado/Módulo 8/Actividad Trabajo/data/Captura de pantalla 2025-03-13 a las 9.00.27.png", clamp=True)
